...
export $CR_ARCH
CR_DTSFILES_J4="exynos7570-j4lte_mea_open_00.dtb exynos7570-j4lte_mea_open_01.dtb exynos7570-j4lte_mea_open_02.dtb"
CR_CONFG_J4=exynos7570-j4lte_defconfig
CR_VARIANT_J4=J4
CLEAN_SOURCE()
{
echo "Cleaning"
...
PACK_BOOT_IMG()
{
	...
	cp $CR_OUT/boot.img  /home/m/share/j4kernel/minhka/j4/boot.img
	$CR_AIK/cleanup.sh 
}
            clear
            CLEAN_SOURCE
